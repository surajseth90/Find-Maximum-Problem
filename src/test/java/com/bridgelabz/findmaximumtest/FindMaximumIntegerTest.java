...
public class FindMaximumIntegerTest {
	...
	public void givenFirstInteger_whenMax_shouldReturnTrue() {
		Integer max =20;
		Assert.assertEquals(max,FindMaximum.findMaxInteger(20, 10, 5) );
	}
	@Test
	public void givenSecondInteger_whenMax_shouldReturnTrue() {
		Integer max =45;
		Assert.assertEquals(max,FindMaximum.findMaxInteger(20, 45, 5) );
	}
	@Test
	public void givenThirdInteger_whenMax_shouldReturnTrue() {
		Integer max =50;
		Assert.assertEquals(max,FindMaximum.findMaxInteger(20, 10, 50) );
	}
}
